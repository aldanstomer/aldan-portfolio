    ...
    <div class="relative w-full max-w-sm mx-auto p-1 rounded-[2.5rem] bg-gradient-to-b from-white/10 to-white/5 border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.5)] backdrop-blur-md">
        <div class="relative rounded-[2.25rem] overflow-hidden border border-slate-700 bg-slate-900 shadow-xl">
            <div class="relative">
                ...
                <div class="pointer-events-none absolute inset-x-0 bottom-0 h-62 backdrop-blur-xl bg-white/10 [mask-image:linear-gradient(to_top,black_0%,black_45%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_top,black_0%,black_45%,transparent_100%)]" />
                <div class="absolute inset-x-0 bottom-0 z-10 p-6">
                    <div class="flex items-center gap-3">
                        <h3 class="text-2xl font-semibold text-white">{{ props.name }}</h3>
                        <div class="w-6 h-6 rounded-full bg-blue-500/90 backdrop-blur flex items-center justify-center shadow-md">
